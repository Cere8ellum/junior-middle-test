...
export default function Home() {
  ...
  <div className={styles.dialog}>
      <div className={styles.dialog__header}>
          <div className={styles.dialog__headerTitleContainer}>
              <div className={styles.dialog__headerTitle}>
                  Ссъешь ещё этих мягких французских булок, да выпей чаю
              </div>
              <div className={styles.dialog__headerSubtitle}>
                  Съешь ещё этих мягких французских булок, да выпей чаю
              </div>
          </div>
          <button className={styles.dialog__headerButton}>
              Кнопка закрытия
          </button>
      </div>
      <div className={styles.dialog__content}>
          <div className={[styles.dialog__contentBlock, styles.dialog__contentBlock_left].join(" ")}>
              Left
          </div>
          <div className={[styles.dialog__contentBlock, styles.dialog__contentBlock_right].join(" ")}>
